...
# -------------------------
    ...
    df_reg['Diabetes_flag'] = df_reg['patient has diabetes'].astype(int)
    ...
    df_reg['WeightedBaseline'] = (
        ...
        + df_reg['Diabetes_flag'] * weights['Diabetes']
    )
    ...
    interpretation_map = {
        ...
        'Cardiac Rehab':
            "assumed 25% reduction in complications & LOS (Arthur 2000; Nery 2007; Barakat 2016).",
        'Pulmonary Prehab':
